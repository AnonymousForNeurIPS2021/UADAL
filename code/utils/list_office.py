...
for domain in ['amazon', 'dslr', 'webcam']:
    ...
    path_source_domain = os.path.join(data_domain_path, 'office31_%s_source_list_v2.txt'%(domain))
    write_source_domain = open(path_source_domain, "w")
    path_target_domain = os.path.join(data_domain_path, 'office31_%s_target_list_v2.txt'%(domain))
